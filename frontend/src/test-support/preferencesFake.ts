...
export function makeFakePrefs() {
  return {
    dual: {
      ...
      trayEnabled: fakeDual('tray_enabled', false),
      trayOnClose: fakeDual('tray_on_close', 'tray'),
      trayOnMinimize: fakeDual('tray_on_minimize', 'taskbar'),
      startOnLogin: fakeDual('start_on_login', false),
      startMinimized: fakeDual('start_minimized', 'window'),
    },
