...
// Safe-area inset values. Non-zero on an iOS/Android PWA (or iPhone Safari)
// with `viewport-fit=cover` for the status bar / Dynamic Island / notch /
// home indicator / display cutout; 0px on ordinary desktop browsers.
