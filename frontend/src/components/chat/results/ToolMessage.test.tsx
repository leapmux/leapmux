...
/**
 * An image TAB addresses a picture by its index in `imagesForRow`, and the row hands
 ...
 * a paired request row draws the answer a second time -- and `imagesForRow` reports NO
...
/**
 * The three SOURCES a row draws pictures from, each at the index `imagesForRow`
