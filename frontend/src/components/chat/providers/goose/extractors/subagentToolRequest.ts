import { GOOSE_SUBAGENT_REQUEST } from '~/generated/contracts/goose-protocol'
...
export function gooseSubagentToolCall(parent: Record<string, unknown>): Record<string, unknown> | undefined {
  return pickObject(subagentRequestData(parent), GOOSE_SUBAGENT_REQUEST.ToolCall) ?? undefined
}
