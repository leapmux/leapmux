...
/**
 * How one subagent run ended: {@link RunOutcome}, whole.
 *
 ...
 */
export type AgentOutcome = RunOutcome
...
export interface AgentRun {
   ...
   * Display PROSE, and deliberately open. It is NOT `ToolCallCommon.status`, which is
