...
import { commandCollapseThreshold, commandExit, commandIsError, commandOutputIsCollapsible, commandStatusLabel, normalizedCommandOutput } from './commandResult'
...
describe('commandStatusLabel', () => {
  ...
  // The status outranks a zero exit code, as it did before the row IR: a row the
