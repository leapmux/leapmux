...
require (
	...
	github.com/leapmux/leapmux v0.0.0-20260429115838-ff6b04b1a39f
...
replace github.com/leapmux/leapmux => ../../backend
...
// errors when `go tool golangci-lint` compiles with our merged dep
// graph. Pin genproto to a post-split version so overlapping paths
// exist only in the split modules.
