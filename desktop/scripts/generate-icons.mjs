...
// Usage: node generate-icons.mjs <png-svg-path> <ico-svg-path> <png-out> <ico-out>
//
...
const [pngSvgPath, icoSvgPath, pngOut, icoOut] = process.argv.slice(2)
if (!pngSvgPath || !icoSvgPath || !pngOut || !icoOut) {
  console.error('Usage: generate-icons.mjs <png-svg> <ico-svg> <png-out> <ico-out>')
  process.exit(1)
}
