...
cp -a "${APP_PATH}" "${STAGING_DIR}/LeapMux.app"
APP_SIZE_KB=$(du -sk "${STAGING_DIR}/LeapMux.app" | awk '{print $1}')
...
cp -a "${APP_PATH}" "${MOUNT_POINT}/LeapMux.app"
