...
func (h *IdPHandler) StartTokenRefresh(ctx context.Context) {
...
func (h *IdPHandler) refreshExpiringTokens(ctx context.Context) {
	...
	// calls. IdPHandler caches the built Provider itself.
