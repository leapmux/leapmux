...
// own subject, and two more wrapped it once apiece -- one of the nine had
...
//
// subject names what is unavailable, in the sentence "solo mode does not
...
// correctly for a plural subject and a singular one alike -- the nine hand
// written copies chose their own verb, and a template that kept the passive
