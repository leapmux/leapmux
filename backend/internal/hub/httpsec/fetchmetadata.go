...
// a page cannot forge. Four values are defined, and only two of them describe
// a request some other site caused:
//
...
// header on somebody else's browser. Fail-open here buys the modern majority a
