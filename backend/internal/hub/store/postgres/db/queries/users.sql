...
UPDATE users SET pending_email = sqlc.arg(pending_email), pending_email_token = sqlc.arg(pending_email_token), pending_email_expires_at = sqlc.narg(pending_email_expires_at), pending_email_issued_at = sqlc.narg(pending_email_issued_at), pending_email_attempts = 0, updated_at = NOW()
