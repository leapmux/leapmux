...
var publicProcedureRationale = map[string]string{
	...
	leapmuxv1connect.AuthServiceGetCaptchaChallengeProcedure:   "discloses only a self-authenticating PoW challenge (no secret); needed pre-login so the captcha widget can arm Login/SignUp",
