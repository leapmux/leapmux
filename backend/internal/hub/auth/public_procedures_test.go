...
var publicProcedureRationale = map[string]string{
	...
	leapmuxv1connect.AuthServiceRequestAccountRecoveryProcedure:  "self-service break-glass: issues a reset email when SMTP is configured",
	leapmuxv1connect.AuthServiceCompleteAccountRecoveryProcedure: "self-service break-glass: consumes a single-use reset token and sets a new password",
