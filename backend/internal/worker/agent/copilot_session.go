...
func newCopilotSessionConfig(opts Options, sessionID string, resume bool) copilotSessionConfig {
...
func (c *copilotConnection) openSession(opts Options, sessionID string, resume bool, timeout time.Duration) (copilotSessionInfo, error) {
