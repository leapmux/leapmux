...
func (a *GooseCLIAgent) gooseToolOutputProgress(update acpToolCallUpdateEnvelope) (int64, bool, bool) {
	var meta struct {
	...
	if json.Unmarshal(update.Meta, &meta) != nil || meta.ToolNotification.Type != "live_output" {
