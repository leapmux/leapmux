...
func handleCodexOutput(a *CodexAgent, content []byte) {
	...
	default:
		...
		if err := a.sink.PersistMessage(leapmuxv1.MessageRole_MESSAGE_ROLE_ASSISTANT, content, "", "", -1, false); err != nil {
...
func (a *CodexAgent) handleItemStarted(params json.RawMessage) {
	...
	case "commandExecution", "fileChange", "mcpToolCall", "dynamicToolCall":
		...
		if err := a.sink.PersistMessage(leapmuxv1.MessageRole_MESSAGE_ROLE_ASSISTANT, params, parentSpanID, itemID, spanColor, false); err != nil {
	...
	case "collabAgentToolCall":
		...
		if err := a.sink.PersistMessage(leapmuxv1.MessageRole_MESSAGE_ROLE_ASSISTANT, params, parentSpanID, itemID, -1, false); err != nil {
...
func (a *CodexAgent) handleItemCompleted(params json.RawMessage) {
	...
	case "commandExecution", "fileChange", "mcpToolCall", "dynamicToolCall":
		...
		if err := a.sink.PersistMessage(leapmuxv1.MessageRole_MESSAGE_ROLE_ASSISTANT, params, parentSpanID, itemID, -1, true); err != nil {
...
func (a *CodexAgent) handleTurnCompleted(params json.RawMessage) {
	...
	if err := a.sink.PersistMessage(leapmuxv1.MessageRole_MESSAGE_ROLE_RESULT, params, "", "", -1, false); err != nil {
