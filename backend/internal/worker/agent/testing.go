...
func (m *Manager) MockStartAgent(ctx context.Context, opts Options, sink ProviderServices) (map[string]string, error) {
...
func wireClaudeMockAgent(ctx context.Context, cancel context.CancelFunc, cmd *exec.Cmd, opts Options, sink ProviderServices) (*ClaudeCodeAgent, error) {
