...
func piFreshImplementationFixture() (*PiAgent, *recordingControlSink, *bytes.Buffer) {
	output := &bytes.Buffer{}
...
func publishedRequestIDs(sink *recordingControlSink) []string {
	ids := make([]string, 0)
...
func approvePiFreshImplementation(t *testing.T, a *PiAgent) {
	t.Helper()
