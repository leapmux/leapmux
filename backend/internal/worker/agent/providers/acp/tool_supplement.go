...
type ToolSupplement map[string]json.RawMessage
...
// NewToolSupplement starts an envelope that identifies the frame it belongs to.
func NewToolSupplement(original map[string]json.RawMessage) ToolSupplement {
	supplement := make(ToolSupplement, len(contracts.ACPSupplementIdentityKeys))
...
func (s ToolSupplement) IdentityMatches(original map[string]json.RawMessage) bool {
...
func (s ToolSupplement) setProtocol(protocol map[string]json.RawMessage) error {
...
func (s ToolSupplement) setTerminals(terminals map[string]contracts.ACPTerminalResult) error {
...
func (s ToolSupplement) SetRawOutput(output any) error {
