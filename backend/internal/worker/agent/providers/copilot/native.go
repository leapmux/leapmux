...
func (a *copilotAgent) PublishTurnActive() agent.TurnState {
	a.stateMu.Lock()
	active := a.active
...
func (a *copilotAgent) handleNativeOutput(line *providerkit.ParsedLine) {
	a.outputMu.Lock()
...
func (a *copilotAgent) persistNativeFrame(raw []byte, span agent.SpanInfo) {
