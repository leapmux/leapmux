...
func codexGoalStatus(wire string) agent.GoalStatus {
	switch wire {
...
func (a *Agent) handleGoalUpdated(params json.RawMessage) {
...
func (a *Agent) handleGoalCleared(params json.RawMessage) {
...
func (a *Agent) PerformGoalAction(action agent.GoalAction, objective string) (agent.GoalOutcome, error) {
	...
	case agent.GoalActionSet:
		return agent.GoalOutcome{}, a.sendGoalSet(map[string]interface{}{"objective": objective})
	case agent.GoalActionPause:
		return agent.GoalOutcome{}, a.sendGoalSet(map[string]interface{}{"status": codexGoalStatusPaused})
	case agent.GoalActionResume:
		return agent.GoalOutcome{}, a.sendGoalSet(map[string]interface{}{"status": codexGoalStatusActive})
...
// between them.
func (a *Agent) sendGoalSet(fields map[string]interface{}) error {
	threadID := a.currentThreadID()
	if threadID == "" {
