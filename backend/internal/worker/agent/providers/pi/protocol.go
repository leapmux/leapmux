...
// answers the dialog itself (see fresh_implementation.go), so the browser
...
const (
	PlanDialogFreshSettingsTitle = "Fresh implementation settings"
	PlanActionStartFresh         = "Start fresh implementation"
)
