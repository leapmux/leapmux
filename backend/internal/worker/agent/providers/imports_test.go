...
var allowedProviderImports = map[string][]string{
	".": {"amp", "claude", "cline", "codebuddy", "codewhale", "codex", "copilot", "cursor", "dirac", "droid", "fastagent", "goose", "grok", "junie", "kilo", "kimi", "kiro", "letta", "mimo", "ohmypi", "opencode", "pi", "qoder", "qwen", "reasonix", "zcode"},
