...
It is **not** aimed at people who want to contribute to LeapMux's own source code — see [Issues and contributions](#issues-and-contributions) below for why.
...
LeapMux is licensed under the **Functional Source License, Version 1.1, Apache 2.0 Future License (FSL-1.1-ALv2)**. Under this license the source is available, but the project does **not** accept code contributions at this time.

What the maintainers do welcome is **issues**. If you hit a bug or want a feature, please open an issue at the project's GitHub repository — preferably with a plan generated by a frontier model attached — and the maintainers will follow up.
