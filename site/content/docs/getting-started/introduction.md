...
- **Persistent sessions** — Agent sessions resume across restarts and reconnects — no manual `--resume` juggling. Terminals keep their live shell across reconnects and browser refreshes; restarting the Worker they run on ends the shell, so the terminal returns showing its last screen and restarts on demand.
...
- **Using LeapMux** — the daily workflow in the order you meet it: [Workspaces](/docs/using/workspaces/), [Tabs & Layout](/docs/using/tabs-and-layout/), [Coding Agents](/docs/using/coding-agents/), [Worktrees & Branches](/docs/using/worktrees-and-branches/), [Terminals](/docs/using/terminals/), [File Browser](/docs/using/file-browser/), and [Device Sync](/docs/using/device-sync/); then your account and how the app is tuned: [Accounts & Authentication](/docs/using/accounts/), [Connected Apps](/docs/using/connected-apps/), [Settings & Preferences](/docs/using/settings/), and [Keyboard Shortcuts](/docs/using/keyboard-shortcuts/).
- **Operating** — [Running LeapMux](/docs/operating/running-leapmux/), [Configuration](/docs/operating/configuration/), [Managing Workers](/docs/operating/managing-workers/), [Sign-in Providers](/docs/operating/sign-in-providers/), [App Authorization](/docs/operating/app-authorization/), which covers the OAuth apps that ask your Hub for access to accounts, [Encryption & Data](/docs/operating/encryption-and-data/), [Security & Threat Model](/docs/operating/security/), [Control CLI](/docs/operating/control-cli/) for driving a running instance (or scripting an agent) with `leapmux control`, [Admin CLI](/docs/operating/admin-cli/) for hub administration, and [Recovery](/docs/operating/recover/), the offline break-glass tree.
