...
- **Using LeapMux** — [Accounts & Authentication](/docs/using/accounts/), [Connected Apps](/docs/using/connected-apps/), [Workspaces](/docs/using/workspaces/), [Tabs & Layout](/docs/using/tabs-and-layout/), [Coding Agents](/docs/using/coding-agents/), [Worktrees & Branches](/docs/using/worktrees-and-branches/), [Terminals](/docs/using/terminals/), [File Browser](/docs/using/file-browser/), [Device Sync & Presence](/docs/using/collaboration/), [Settings & Preferences](/docs/using/settings/), and [Keyboard Shortcuts](/docs/using/keyboard-shortcuts/).
- **Running & operating** — [Running LeapMux](/docs/operating/running-leapmux/), [Configuration](/docs/operating/configuration/), [Managing Workers](/docs/operating/managing-workers/), [Recovery](/docs/operating/recover/), [Sign-in Providers](/docs/operating/sign-in-providers/), [App Authorization](/docs/operating/app-authorization/), which covers the OAuth apps that ask your Hub for access to accounts, [Encryption & Data](/docs/operating/encryption-and-data/), [Security & Threat Model](/docs/operating/security/), and [Remote Control CLI](/docs/operating/control-cli/), which covers driving a running instance (or scripting an agent) with `leapmux control`.
