...
- **Running & operating** — [Running LeapMux](/docs/operating/running-leapmux/), [Configuration](/docs/operating/configuration/), [Managing Workers](/docs/operating/managing-workers/), [Recovery](/docs/operating/recover/), [Sign-in Providers](/docs/operating/sign-in-providers/), [Encryption & Data](/docs/operating/encryption-and-data/), [Security & Threat Model](/docs/operating/security/), and [Remote Control CLI](/docs/operating/control-cli/), which covers driving a running instance (or scripting an agent) with `leapmux control`.
