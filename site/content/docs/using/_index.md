...
coding agents and terminals, browsing files, and collaborating.

{{< cards >}}
  {{< card link="/docs/using/accounts/" title="Accounts & Authentication" icon="user" subtitle="Sign up, sign in, and link OAuth providers." >}}
  {{< card link="/docs/using/organizations/" title="Organizations & Members" icon="user-group" subtitle="Orgs, roles, and inviting members." >}}
  {{< card link="/docs/using/workspaces/" title="Workspaces" icon="collection" subtitle="Create, organize, share, and archive workspaces." >}}
  ...
  {{< card link="/docs/using/collaboration/" title="Collaboration & Presence" icon="users" subtitle="What syncs live across people and devices." >}}
